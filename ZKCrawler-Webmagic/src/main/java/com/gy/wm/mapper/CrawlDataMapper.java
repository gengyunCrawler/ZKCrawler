...
public interface CrawlDataMapper {
    @Insert("INSERT INTO crawlerdata_test(tid,url,statusCode,pass,type,rootUrl,fromUrl,text,html,title,startTime,crawlTime,publishTime,depthfromSeed,count,tag,fetched,author,sourceName,parsedData) VALUES " +
