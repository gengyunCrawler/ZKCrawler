package cn.com.cloudpioneer.taskclient.tasks;
...
import cn.com.cloudpioneer.taskclient.utils.ObjectSerializeUtils;
...
public class MyTasks {
     ...
     * @param task 要添加的任务。
     */
    public boolean addTask(String field, TaskModel task) {
        ...
        try {
            ...
            return jedis.hset(key.getBytes(), field.getBytes(), bytesTaskModel) > 0;
