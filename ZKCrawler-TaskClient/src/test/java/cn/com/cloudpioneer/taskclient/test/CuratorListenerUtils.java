...
/**
 * Created by Tianjinjin on 2016/9/6.
 */
...
/**
    ...
    private static CuratorFramework clientOne(){
        //zk 地址
        String connectString = "192.168.229.130:2181";
        // 连接时间 和重试次数
...
/**
    ...
    private static CuratorFramework clientTwo() throws Exception {
...
/*CuratorFramework client = CuratorFrameworkFactory.builder().
        ...
        client.start();
        client.create().forPath("/aaa", "I love messi".getBytes());
        return client;
    }
